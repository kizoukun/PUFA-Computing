...
export default function CardStore({
   ...
   return (
      <Link href="/">
         <div className="max-w-xs aspect-square p-3 rounded-md shadow-md hover:shadow-lg hover:shadow-[#BA704F] transition duration-300 ease-in-out border border-[#BA704F]">
            <img
               src={image}
               alt={`${title}'s images`}
