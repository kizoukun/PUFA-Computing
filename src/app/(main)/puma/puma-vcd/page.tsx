...
export default function VCDPage() {
      ...
      <div
        ...
        <div className="max-w-lg mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="py-4 px-6">
            ...
            <p className="mt-2 text-lg text-gray-600">We are working hard to bring you the information PUMA Visual Communication Design. Stay
              tuned!</p>
          </div>
